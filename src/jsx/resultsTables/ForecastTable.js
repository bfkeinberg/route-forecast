...
import { Button, HTMLTable, Icon, Tooltip, Section } from '@blueprintjs/core';
            ...
            return (
                ...
                <>
                    ...
                    <tr key={point.distance+Math.random().toString(10)}
                        ...
                        <td style={styleForControl(point)} className='timeCell'><Time time={index === forecast.length-1 ? null : getAdjustedTime(point,index,adjustedTimes)}/></td>
