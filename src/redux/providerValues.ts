...
export const providerValues : ProviderValues = {
    ...
    visualcrossing:{min_interval:1, max_days:14, canForecastPast:true, daysInPast:4, name:"Visual Crossing", enabled:true},
    weatherapi:{min_interval:1, max_days:10, canForecastPast:false, daysInPast:4, name:"WeatherAPI", enabled:true},
    weatherKit:{min_interval:0.25, max_days:8, canForecastPast:true, daysInPast:12, name:"Apple WeatherKit", enabled:true},
